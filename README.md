...
Usually, for this feature the files are stored in a WordPress theme. This plugin just make use of the filters to change the directory that ACF searches for, so they can be stored inside this plugin. Built especially for [Oxygen](http://oxygenbuilder.com/) where the theme is completely disabled.
